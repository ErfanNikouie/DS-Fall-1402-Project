...
public class FamilyTreeMock : MonoBehaviour
{
    ...
    void Start()
    {
        //CreateFamily(view.Controller);
        CreateSimpleFamily(view.Controller);
    }

    void CreateFamily(FamilyTreeController ft)
    {
    ...
    void CreateSimpleFamily(FamilyTreeController ft)
    {
        Person father = new Person("Father");
        PersonID fatherid = ft.GetUniquePersonID();
        ft.AddPerson(father);
